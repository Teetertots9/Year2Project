...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """gallerya""", """controllers.HomeController.gallerya"""),
  ...
  // @LINE:7
  private[this] lazy val controllers_HomeController_gallerya1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("gallerya")))
  )
  private[this] lazy val controllers_HomeController_gallerya1_invoker = createInvoker(
    HomeController_3.gallerya,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "gallerya",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_HomeController_gallerya1_route(params@_) =>
      call { 
        controllers_HomeController_gallerya1_invoker.call(HomeController_3.gallerya)
      }
